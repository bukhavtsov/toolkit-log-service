...
//
// TODO: Extend the ToolkitLogService service by defining new RPCs and
...
//
// TODO: Create an implementation of the ToolkitLogService server
...
// implementation of ToolkitLogService server interface service, but only
...
// Default implementation of the ToolkitLogService server interface
type server struct{}
...
func NewBasicServer() (pb.ToolkitLogServiceServer, error) {
	return &server{}, nil
}
